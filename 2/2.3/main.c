...
int main(void) {
    double (*operations[])(const int, ...) = {sum, sub, mult, div}; // Массив указателей на функции
    ...
    while(work){
        ...
        switch(cmd)
        {
            case 1: 
                ...
                result = operations[cmd-1](count, numbers[0], numbers[1], numbers[2], numbers[3], numbers[4],
